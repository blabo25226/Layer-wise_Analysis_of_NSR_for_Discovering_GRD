...
| C0001-INFRA-T002 | C0001 | infrastructure | repo-operator | Cursor Agent | `ai/C0001/repo-operator/capacity-routing` / `/tmp/lansr-multiai-C0001-capacity-routing` | routing rules, roles, adapters, evidence inventory, smoke | completed | Gemini PASS_WITH_LIMITATIONS + Claude PASS closure; ready for PI integration |
...
| C0001-INFRA-T002-PI-INTEGRATION | C0001 | infrastructure | research-pi | Codex PI | shared capacity-routing worktree | integrate to remote research branch | pending | integrate accepted routing policy, push, verify remote SHA |
