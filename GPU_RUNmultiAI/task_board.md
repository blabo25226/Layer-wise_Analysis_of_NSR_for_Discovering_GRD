...
| C0001-T006 | C0001 | scientific | research-engineer / repo-operator | Cursor Agent | `ai/C0001/research-engineer/implement-metric-audit` / `/tmp/lansr-multiai-C0001-implement-audit` | new audit module, CLI, focused tests, completion record | completed_pending_review | PI + reproducibility-auditor review; 14/14 focused tests PASS; smoke local only |
