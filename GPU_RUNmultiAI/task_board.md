...
| C0001-T005 | C0001 | scientific | repo-operator + independent reviewer + PI | Cursor Agent + Codex subagent + Codex PI | `ai/C0001/repo-operator/revise-preregistration` / `/tmp/lansr-multiai-C0001-revise-prereg` | preregistration v9, review chain, PASS closure, freeze record | integrated_pending_push | binding SHA `60cfed79780c6b027192a3da14e69416d72090e0a89dddd22248b0f00f50cf00`; root integration checks PASS |
