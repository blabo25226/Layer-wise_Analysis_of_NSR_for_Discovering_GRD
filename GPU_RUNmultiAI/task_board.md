...
| C0001-INFRA-T002 | C0001 | infrastructure | repo-operator | Cursor Agent | `ai/C0001/repo-operator/capacity-routing` / `/tmp/lansr-multiai-C0001-capacity-routing` | routing rules, roles, adapters, evidence inventory, smoke | completed | canonical routing updated; see smoke report |
| C0001-INFRA-T002-GEMINI-SMOKE | C0001 | infrastructure | research-scout | Gemini / Antigravity | shared capacity-routing worktree | prompt-supplied evidence packet | planned | classify inventory; evidence/inference/speculation |
| C0001-INFRA-T002-CLAUDE-SMOKE | C0001 | infrastructure | scientific-critic | Claude Opus | shared capacity-routing worktree | compressed-packet audit | planned | scientific-quality audit after Gemini smoke |
