...
| C0001-INFRA-T002 | C0001 | infrastructure | repo-operator | Cursor Agent | `ai/C0001/repo-operator/capacity-routing` / `/tmp/lansr-multiai-C0001-capacity-routing` | routing rules, roles, adapters, evidence inventory, smoke | planned | Cursor reconnaissance and implementation |
