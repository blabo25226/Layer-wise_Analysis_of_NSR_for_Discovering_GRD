...
| C0001-T006-R2 | C0001 | scientific | research-engineer / repo-operator | Cursor Agent | `ai/C0001/research-engineer/implement-metric-audit` / `/tmp/lansr-multiai-C0001-implement-audit` | guard re-entrancy + import ordering repair | ready_for_review | PI review; lansr310 22 passed / 1 failed (E1 oracle); pytest exit 1 |
| C0001-T006-R1 | C0001 | scientific | research-engineer / repo-operator | Cursor Agent | `ai/C0001/research-engineer/implement-metric-audit` / `/tmp/lansr-multiai-C0001-implement-audit` | R1 repair of blocked audit implementation | superseded_by_T006_R2 | see T006-R2 |
| C0001-T006 | C0001 | scientific | research-engineer / repo-operator | Cursor Agent | `ai/C0001/research-engineer/implement-metric-audit` / `/tmp/lansr-multiai-C0001-implement-audit` | new audit module, CLI, focused tests, completion record | superseded_by_T006_R1 | blocked at 88720c1; see T006-R1 |
