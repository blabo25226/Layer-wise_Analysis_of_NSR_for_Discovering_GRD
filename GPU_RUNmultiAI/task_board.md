...
| C0001-T001 | C0001 | research-scout | Codex subagent | shared read-only checkout | none | running | repository-state evidence handoff |
| C0001-T002 | C0001 | hypothesis-scientist | Codex subagent | shared read-only checkout | none | running | ranked competing hypotheses |
| C0001-T003 | C0001 | statistical-reviewer | Codex subagent | shared read-only checkout | none | running | discriminating design audit |
