...
| C0001-INFRA-T003 | C0001 | infrastructure | repo-operator | Cursor Agent | `ai/C0001/repo-operator/routing-refresh` / `/tmp/lansr-multiai-C0001-routing-refresh` | routing refresh, gemini broker, model update, MANIFEST | p2_pass_pending_pi_integration | direct FS FAIL (0/5); broker smoke PASS 06:47; live broker FAIL exit70; Claude P2 PASS |
