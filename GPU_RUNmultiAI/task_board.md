...
| C0001-INFRA-T003 | C0001 | infrastructure | repo-operator | Cursor Agent | `ai/C0001/repo-operator/routing-refresh` / `/tmp/lansr-multiai-C0001-routing-refresh` | routing refresh, gemini broker, model update, MANIFEST | remediation_after_claude_BLOCK | direct FS FAIL (0/5); broker PASS; Claude BLOCK remediated on branch |
