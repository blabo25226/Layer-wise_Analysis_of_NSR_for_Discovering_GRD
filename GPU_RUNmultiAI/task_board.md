...
| C0001-T005 | C0001 | scientific | repo-operator | Cursor Agent | `ai/C0001/repo-operator/revise-preregistration` / `/tmp/lansr-multiai-C0001-revise-prereg` | preregistration v4, v3 review response, v3 independent review | ready_for_independent_closure_review | independent closure review of v4 (not frozen/approved); distinct reviewer before PI freeze |
