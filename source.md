...
WeakIdent / WeakIdent: Weak formulation for Identifying Differential Equations using Narrow-fit and Trimming
論文
https://www.sciencedirect.com/science/article/pii/S002199912300164X
ソースコード
http://github.com/sunghakang/WeakIdent
...
D-CODE / D-CODE: Discovering Closed-form ODEs from Observed Trajectories
論文
...
DSR / Deep Symbolic Regression（Deep symbolic regression: Recovering mathematical expressions from data via risk-seeking policy gradients）
論文
