...
| ファイル | 範囲 |
|---|---|
| `test_gnw_synthetic.py` | GNW式、240 problems、algebraic template ID（G02=G03、G07=G08）、paired noise、domain範囲、有限差分非使用 |
...
| `test_live_paths.py` | GNW→fine-tune式、dummy record、selective-FTからoutput_head除外、template/next-token probe、DecoderLens parse、ablation hook、Phase 4 ranking / runner test split |
